...
describe '#Definition' do
  ...
  before(:each) do
    Word.clear
    Definition.clear
    @word = Word.new({:word => "Giant Steps", :id => nil})
    @word.save()
  end
  ...
  describe('#==') do
    it("is the same definition if it has the same attributes as another definition") do
      ...
      definition2 = Definition.new({:word => "Naima", :word_id => @word.id, :id => nil})
  ...
  describe('.all') do
    it("returns a list of all definitions") do
      definition = Definition.new({:word => "Giant Steps", :word_id => @word.id, :id => nil})
      definition.save()
      definition2 = Definition.new({:word => "Naima", :word_id => @word.id, :id => nil})
      definition2.save()
  ...
  describe('.find_by_word') do
    it("finds definitions for an word") do
      ...
      definition = Definition.new({:word => "Naima", :word_id => @word.id, :id => nil})
      definition.save()
      definition2 = Definition.new({:word => "California", :word_id => word2.id , :id => nil})
      definition2.save()
